    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
          ...
          <p>
            By accessing or using the Mentor Platform service, you acknowledge that you have read,
          ...
          <p>
            Mentor Platform provides a platform connecting mentors and learners for professional development
            purposes. The service facilitates communication, scheduling, and resource sharing between users.
          </p>
          ...
          <p>
            You agree to use the service in compliance with all applicable laws and regulations. You are
          ...
          <p>
            The service and its contents are protected by copyright, trademark, and other laws. Our
