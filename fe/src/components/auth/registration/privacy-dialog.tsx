    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
          ...
          <p>
            We collect information you provide directly to us when creating an account or updating your
            profile, including:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Session data and content you share on the platform</li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>With other users as part of the mentorship matching process (based on your privacy settings)</li>
            ...
            <li>If we believe disclosure is necessary to protect the rights, property, or safety of our users</li>
          ...
          <p>
            You can access and update certain information through your account settings. You can also
            request deletion of your account by contacting us. Note that we may retain certain information
          ...
          <p>
            ...
            and to distinguish you from other users. You can instruct your browser to refuse all cookies
            or to indicate when a cookie is being sent.
          </p>
          
          <h3 className="text-lg font-semibold">7. Children's Privacy</h3>
          <p>
            Our service is not directed to children under 16, and we do not knowingly collect personal
            information from children under 16. If we learn we have collected personal information from
            a child under 16, we will delete this information.
          </p>
          ...
          <p>
            If you have any questions about this privacy policy, please contact us at privacy@mentorplatform.com.
          </p>
        </div>
        <DialogFooter>
